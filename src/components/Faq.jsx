            ...
            <section className='faq-bg py-faq mt-decrease' id='WhitePaper'>
                <Container>
                    <div className=' flex-column d-flex align-items-center'>
                        <h2 className=' mb-0 manrope fw-600 text-48 lh-57 white text-center'>Frequently Asked <span className='yellow'>Questions</span></h2>
                        <div className='max-w-800 z-30 w-100 mx-auto mt-acordian'>
                            <Accordion defaultActiveKey="0" >
                                ...
                                <Accordion.Item eventKey="1" className='mt_accordian'>
                                ...
                                <Accordion.Item eventKey="3" className='mt_accordian'>
                                ...
                                <Accordion.Item eventKey="4" className='mt_accordian'>
                                ...
                                <Accordion.Item eventKey="5" className='mt_accordian'>
                                ...
                                <Accordion.Item eventKey="6" className='mt_accordian'>
                                ...
                                <Accordion.Item eventKey="7" className='mt_accordian'>
