            ...
            <section className=' bg-black bg-token-img pb-token mt-decrease position-relative' id='Tokenomics'>
                <Container>
                    <Row className=' py-token '>
                        <Col lg={6} className=' d-flex justify-content-center justify-content-lg-start align-items-lg-center'>
                        ...
                        <Col lg={6} className=' d-flex justify-content-center justify-content-lg-end mt-4 mt-lg-0'>
                            <img className=' w-100 max-491' src={tokenimg} alt="image" />
                        </Col>
                    </Row>
                    <div className='community-box gradient-border2 w-100 d-flex justify-content-lg-between justify-content-center flex-wrap flex-lg-nowrap align-items-center mx-auto '>
